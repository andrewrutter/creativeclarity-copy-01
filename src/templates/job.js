...
export default class Job extends React.Component {
    render() {
        ...
        const contactLink="mailto:jobs@creativeclaritycreations.com?subject=" + _.get(this.props, 'pageContext.frontmatter.title')
        return (
            <Layout {...this.props}>
              <Helmet>
            ...
            <div className="outer">
              <div className="inner">
                <article className="post post-full">
                  ...
                  <div className="post-content inner-small">
                    Want to learn more? Simply email your resume to <a href={contactLink}>jobs@creativeclaritycreations.com</a> with the role you are looking for in the subject line
                  </div>
